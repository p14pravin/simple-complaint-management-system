        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="complaints_all.php"><i class="fas fa-table"></i><span>All Complaints</span></a></li>
					<li class="nav-item" role="presentation"><a class="nav-link" href="complaints_pending.php"><i class="fas fa-table"></i><span>Pending</span></a></li>
					<li class="nav-item" role="presentation"><a class="nav-link" href="complaints_in_process.php"><i class="fas fa-table"></i><span>In Process</span></a> </li>
					<li class="nav-item" role="presentation"><a class="nav-link" href="complaints_solved.php"><i class="fas fa-table"></i><span>Solved</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                                        ...
                                        <div class="card-body">
											<div class="form-row">
												<div class="col">
													...
													<div class="form-group" style="margin-bottom: 0px;"><label for="username"><strong>Complaint In Details</strong></label></div>
						...
						<?php 
						if($fetch_complaint['status']!="Solved"){
						?>
							<div class="col">
								<form action="" method="POST">
									<div class="card shadow mb-3">
										<div class="card-header py-3">
											<p class="text-primary m-0 font-weight-bold"><label for="signature" style="color: rgb(255,15,0);"><strong>REMARK*</strong><br></label></p>
										</div>
										<div class="card-header py-3"><p class="text-primary m-0 font-weight-bold">Complaint ID = <?php echo $fetch_complaint['id'];?></p></div>
										<div class="card-body"><label for="signature" style="color: rgb(255,245,0);"><strong>Status*</strong><br></label>
											...
											<div class="form-row">
												<div class="col">
														...
														<div class="form-group"><button class="btn btn-primary btn-sm" value="submit" type="submit">UPDATE STATUS</button></div>
												</div>
											</div>
										</div>
									</div>
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © NDROID2020</span></div>
                </div>
            </footer>
